...
public class Ventas
{
	...
	{
		//método a construir
		valorTotal =(this.detalleVentas[0].getValorTotal()+this.detalleVentas[1].getValorTotal()+this.detalleVentas[2].getValorTotal()+this.detalleVentas[3].getValorTotal());
		valorIVA = (valorTotal*100)/IVA;
